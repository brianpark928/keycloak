 ...
 * @version $Revision: 1 $
 */
public class UpdateAutootp implements RequiredActionProvider, RequiredActionFactory, CredentialRegistrator {
    @Override
    ...
    public void requiredActionChallenge(RequiredActionContext context) {
        Response challenge = context.form()
                ...
                .createResponse(UserModel.RequiredAction.CONFIGURE_AUTOOTP);
    ...
    public String getDisplayText() {
        return "Configure AutoOTP";
    }


    @Override
    public String getId() {
        return UserModel.RequiredAction.CONFIGURE_AUTOOTP.name();
    }
